...
const RULES: { pattern: RegExp; test: Test }[] = [
  ...
  { pattern: /\bcacha[cç]a\b/, test: never },
  { pattern: /\bpisco\b/, test: never },
  ...
  { pattern: /\b(cherry heering|heering|cherry liqueur)\b/, test: prod("heering") },
  ...
  { pattern: /\bcr[eè]me de cacao\b/, test: never },
  { pattern: /\bcr[eè]me de menthe\b/, test: never },
  { pattern: /\bcr[eè]me de violette\b/, test: never },
  { pattern: /\bblackberry liqueur\b/, test: never },
  ...
  { pattern: /\bgrapefruit soda\b/, test: never },
  { pattern: /\bmexican lager\b/, test: prod("corona") },
