...
// Shared by the download route (api/checklists/report) and the email route
// (api/checklists/send-email) so the two ways of getting the same report
// out of the app can't drift apart.
export async function buildChecklistReportBuffer(
